<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns="http://www.mesa.org/xml/B2MML-V0600" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" exclude-result-prefixes="ns0 xs fn">
  ...
  <xsl:template match="/">
    ...
    <ConfirmBOD xmlns="http://www.mesa.org/xml/B2MML-V0600" xmlns:Extended="http://www.mesa.org/xml/B2MML-V0600-AllExtensions">
      <ApplicationArea>
        <Sender>
          <xsl:for-each select="ns:ProcessOperationsPerformance/ns:ApplicationArea/ns:Receiver/ns:LogicalID">
        ...
        <Receiver>
          <xsl:for-each select="ns:ProcessOperationsPerformance/ns:ApplicationArea/ns:Sender/ns:LogicalID">
        ...
        <xsl:for-each select="ns:ProcessOperationsPerformance">
