                        ...
                        <xsl:if test = "SGTXT">
                          ...
                          <xsl:if test = "/WMMBID02/IDOC/FTPSSIG/USRDATE1">
                            <MaterialActualProperty>
                                ...
                                <Value>
                                    <ValueString>
										<xsl:value-of select="concat(substring(/WMMBID02/IDOC/FTPSSIG/USRDATE1,1,4),'-',substring(/WMMBID02/IDOC/FTPSSIG/USRDATE1,5,2),'-',substring(/WMMBID02/IDOC/FTPSSIG/USRDATE1,7,2),'T','00:00:00','Z')"/>
                                    </ValueString>
                                </Value>
                            </MaterialActualProperty>
                          </xsl:if>
						  ...
						  <xsl:if test = "/WMMBID02/IDOC/FTPSSIG/USRDATE2">
	                          <MaterialActualProperty>
	                              ...
	                              <Value>
	                                  <ValueString>
										  <xsl:value-of select="concat(substring(/WMMBID02/IDOC/FTPSSIG/USRDATE2,1,4),'-',substring(/WMMBID02/IDOC/FTPSSIG/USRDATE2,5,2),'-',substring(/WMMBID02/IDOC/FTPSSIG/USRDATE2,7,2),'T','00:00:00','Z')"/>
	                                  </ValueString>
	                              </Value>
	                          </MaterialActualProperty>
						  </xsl:if>
                          ...
                          <MaterialActualProperty>
                              ...
                              <Value>
                                  <ValueString>VT001271</ValueString>
                              </Value>
                          </MaterialActualProperty>
                      </MaterialActual>
                  </SegmentResponse>
